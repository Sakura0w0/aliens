...
def update_bullets(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    check_bullet_alien(ai_settings, screen, stats, sb, ship, aliens, bullets)


def check_bullet_alien(ai_settings, screen, stats, sb, ship, aliens, bullets):
...
def get_number_aliens_x(ai_settings, alien_width):
    ...
    number_aliens_x = int(ava_space_x / (2 * alien_width))
...
def check_play_button(ai_settings, screen, stats, play_button, ship, aliens, bullets, mouse_x, mouse_y):
    ...
    if button_clicked and not stats.game:
